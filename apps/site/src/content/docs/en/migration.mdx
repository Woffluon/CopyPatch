...
CopyPatch packages are ESM-only and require Node.js 20 or newer. Validate the v1-to-embedded-backend migration first, then apply every v3 contract change above.
