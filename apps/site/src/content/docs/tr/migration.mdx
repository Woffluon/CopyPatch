...
CopyPatch paketleri yalnız ESM'dir ve Node.js 20 veya üstünü gerektirir. Önce v1'den gömülü backend mimarisine geçişi doğrulayın, ardından yukarıdaki tüm v3 sözleşme değişikliklerini uygulayın.
